...
from models.taming.losses.lpips import LPIPS
from models.taming.discriminator import NLayerDiscriminator, weights_init
...
class VQLPIPSWithDiscriminator(nn.Module):
    ...
    def forward(self,
        ...
        if self.perceptual_weight > 0:
            p_loss = self.perceptual_loss(inputs.contiguous(),
                                          reconstructions.contiguous())
